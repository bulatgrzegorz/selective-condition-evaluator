...
using TaskEngineAssemblyResolver = SelectiveConditionEvaluator.msbuild.Shared.TaskEngineAssemblyResolver;
...
namespace SelectiveConditionEvaluator.msbuild.Instance
{
    ...
    internal sealed class TaskRegistry : ITranslatable
    {
        ...
        internal class RegisteredTaskRecord : ITranslatable
        {
            ...
            internal bool CanTaskBeCreatedByFactory(string taskName, string taskProjectFile, IDictionary<string, string> taskIdentityParameters, TargetLoggingContext targetLoggingContext, ElementLocation.ElementLocation elementLocation)
            {
            ...
            /// </summary>
            internal TaskFactoryWrapper GetTaskFactoryFromRegistrationRecord(string taskName, string taskProjectFile, IDictionary<string, string> taskIdentityParameters, TargetLoggingContext targetLoggingContext, ElementLocation.ElementLocation elementLocation)
            {
            ...
            private bool GetTaskFactory(TargetLoggingContext targetLoggingContext, ElementLocation.ElementLocation elementLocation, string taskProjectFile)
            {
