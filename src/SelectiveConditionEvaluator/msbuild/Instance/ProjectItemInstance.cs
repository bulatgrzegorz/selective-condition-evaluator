...
namespace SelectiveConditionEvaluator.msbuild.Instance
{
    ...
    internal class ProjectItemInstance :
            ...
            IMetadataContainer
        {
            ...
            public string GetMetadataEscaped(string metadataName)
            {
                ...
                if (metadatum != null && Expander<ProjectProperty, ProjectItem>.ExpressionMayContainExpandableExpressions(metadatum.EvaluatedValueEscaped))
                {
                    ...
                    return expander.ExpandIntoStringLeaveEscaped(metadatum.EvaluatedValueEscaped, ExpanderOptions.ExpandBuiltInMetadata, ElementLocation.ElementLocation.EmptyLocation);
                }
