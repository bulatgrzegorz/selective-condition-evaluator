...
namespace SelectiveConditionEvaluator.msbuild.Instance
{
    ...
    internal sealed class ProjectTaskInstance : ProjectTargetInstanceChild, ITranslatable
    {
        /// <summary>
        ...
        /// </summary>
        private ElementLocation.ElementLocation _continueOnErrorLocation;

        /// <summary>
        /// Location of the MSBuildRuntime attribute, if any
        /// </summary>
        private ElementLocation.ElementLocation _msbuildRuntimeLocation;

        /// <summary>
        /// Location of the MSBuildArchitecture attribute, if any
        /// </summary>
        private ElementLocation.ElementLocation _msbuildArchitectureLocation;
        ...
        internal ProjectTaskInstance(
            ...
            msbuildRuntime,
            msbuildArchitecture,
            new CopyOnWriteDictionary<(string, ElementLocation.ElementLocation)>(StringComparer.OrdinalIgnoreCase),
            new List<ProjectTaskInstanceChild>(),
            location,
            condition == string.Empty ? null : ElementLocation.ElementLocation.EmptyLocation,
            continueOnError == string.Empty ? null : ElementLocation.ElementLocation.EmptyLocation,
            msbuildRuntime == string.Empty ? null : ElementLocation.ElementLocation.EmptyLocation,
            msbuildArchitecture == string.Empty ? null : ElementLocation.ElementLocation.EmptyLocation)
        {
        }
        ...
        internal ProjectTaskInstance(
            ...
            CopyOnWriteDictionary<(string, ElementLocation.ElementLocation)> parameters,
            List<ProjectTaskInstanceChild> outputs,
            ElementLocation.ElementLocation location,
            ElementLocation.ElementLocation conditionLocation,
            ElementLocation.ElementLocation continueOnErrorElementLocation,
            ElementLocation.ElementLocation msbuildRuntimeLocation,
            ElementLocation.ElementLocation msbuildArchitectureLocation)
        {
        ...
        public IDictionary<string, string> Parameters
        {
            get
            {
                ...
                foreach (KeyValuePair<string, (string, ElementLocation.ElementLocation)> parameter in _parameters)
                {
        ...
        internal IDictionary<string, (string, ElementLocation.ElementLocation)> TestGetParameters => _parameters;
        ...
        /// Location of the ContinueOnError attribute, if any
        /// </summary>
        public ElementLocation.ElementLocation ContinueOnErrorLocation
        {
        ...
        /// Location of the MSBuildRuntime attribute, if any
        /// </summary>
        public ElementLocation.ElementLocation MSBuildRuntimeLocation
        {
        ...
        /// Location of the MSBuildArchitecture attribute, if any
        /// </summary>
        public ElementLocation.ElementLocation MSBuildArchitectureLocation
        {
        ...
        /// </summary>
        internal IDictionary<string, (string, ElementLocation.ElementLocation)> ParametersForBuild
        {
        ...
        {
            _parameters[parameterName] = (unevaluatedValue, ElementLocation.ElementLocation.EmptyLocation);
        }
        ...
        internal void AddOutputItem(string taskOutputParameterName, string itemName, string condition)
        {
            ...
            _outputs.Add(new ProjectTaskOutputItemInstance(itemName, taskOutputParameterName, condition ?? String.Empty, ElementLocation.ElementLocation.EmptyLocation, ElementLocation.ElementLocation.EmptyLocation, ElementLocation.ElementLocation.EmptyLocation, condition == null ? null : ElementLocation.ElementLocation.EmptyLocation));
        }
        ...
        internal void AddOutputProperty(string taskOutputParameterName, string propertyName, string condition)
        {
            ...
            _outputs.Add(new ProjectTaskOutputPropertyInstance(propertyName, taskOutputParameterName, condition ?? String.Empty, ElementLocation.ElementLocation.EmptyLocation, ElementLocation.ElementLocation.EmptyLocation, ElementLocation.ElementLocation.EmptyLocation, condition == null ? null : ElementLocation.ElementLocation.EmptyLocation));
        }
        ...
        void ITranslatable.Translate(ITranslator translator)
        {
            ...
            translator.Translate(ref _continueOnErrorLocation, ElementLocation.ElementLocation.FactoryForDeserialization);
            translator.Translate(ref _msbuildRuntimeLocation, ElementLocation.ElementLocation.FactoryForDeserialization);
            translator.Translate(ref _msbuildArchitectureLocation, ElementLocation.ElementLocation.FactoryForDeserialization);

            IDictionary<string, (string, ElementLocation.ElementLocation)> localParameters = _parameters;
            translator.TranslateDictionary(
                ref localParameters,
                ParametersKeyTranslator,
                ParametersValueTranslator,
                count => new CopyOnWriteDictionary<(string, ElementLocation.ElementLocation)>());

            if (translator.Mode == TranslationDirection.ReadFromStream && localParameters != null)
            {
                _parameters = (CopyOnWriteDictionary<(string, ElementLocation.ElementLocation)>)localParameters;
            }
        }
        ...
        private static void ParametersValueTranslator(ITranslator translator, ref (string, ElementLocation.ElementLocation) value)
        {
            if (translator.Mode == TranslationDirection.WriteToStream)
            {
                ...
                translator.Translate(ref item2, ElementLocation.ElementLocation.FactoryForDeserialization);
            }
            else
            {
                var item1 = default(string);
                var item2 = default(ElementLocation.ElementLocation);
