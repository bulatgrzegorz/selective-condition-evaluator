...
using System.Xml;
using SelectiveConditionEvaluator.msbuild.BackEnd.BuildManager;
using SelectiveConditionEvaluator.msbuild.BackEnd.Components.Logging;
using SelectiveConditionEvaluator.msbuild.BackEnd.Components.RequestBuilder;
...
using SelectiveConditionEvaluator.msbuild.Collections.RetrievableEntryHashSet;
using SelectiveConditionEvaluator.msbuild.Construction;
using SelectiveConditionEvaluator.msbuild.Construction.Solution;
...
using SelectiveConditionEvaluator.msbuild.Resources;
using SelectiveConditionEvaluator.msbuild.Shared;
using SelectiveConditionEvaluator.msbuild.Shared.FileSystem;
using ForwardingLoggerRecord = SelectiveConditionEvaluator.msbuild.BackEnd.Components.Logging.ForwardingLoggerRecord;
using ObjectModel = System.Collections.ObjectModel;
using ProjectItemInstanceFactory = SelectiveConditionEvaluator.msbuild.Instance.ProjectItemInstance.TaskItem.ProjectItemInstanceFactory;
using SdkResult = SelectiveConditionEvaluator.msbuild.BackEnd.Components.SdkResolution.SdkResult;
...
namespace SelectiveConditionEvaluator.msbuild.Instance
{
    ...
    internal class ProjectInstance : IPropertyProvider<ProjectPropertyInstance>, IItemProvider<ProjectItemInstance>, IEvaluatorData<ProjectPropertyInstance, ProjectItemInstance, ProjectMetadataInstance, ProjectItemDefinitionInstance>, ITranslatable
    {
        /// <summary>
        ...
        public ProjectInstance(Project project, ProjectInstanceSettings settings)
        {
            ...
            _projectFileLocation = ElementLocation.ElementLocation.Create(projectPath);
        ...
        {
            _projectFileLocation = ElementLocation.ElementLocation.Create(projectFile);
        ...
        internal ProjectInstance(Project.Data data, string directory, string fullPath, HostServices hostServices, PropertyDictionary<ProjectPropertyInstance> environmentVariableProperties, ProjectInstanceSettings settings)
        {
            ...
            var immutable = (settings & ProjectInstanceSettings.Immutable) == ProjectInstanceSettings.Immutable;
            this.CreatePropertiesSnapshot(new Shared.ReadOnlyCollection<ProjectProperty>(data.Properties), immutable);

            this.CreateItemDefinitionsSnapshot(data.ItemDefinitions);

            var keepEvaluationCache = (settings & ProjectInstanceSettings.ImmutableWithFastItemLookup) == ProjectInstanceSettings.ImmutableWithFastItemLookup;
            var projectItemToInstanceMap = this.CreateItemsSnapshot(new Shared.ReadOnlyCollection<ProjectItem>(data.Items), data.ItemTypes.Count, keepEvaluationCache);

            this.CreateEvaluatedIncludeSnapshotIfRequested(keepEvaluationCache, new Shared.ReadOnlyCollection<ProjectItem>(data.Items), projectItemToInstanceMap);
        ...
        public ICollection<ProjectPropertyInstance> Properties
        {
            ...
            get
            {
                return (_properties == null) ?
                    ...
                    new Shared.ReadOnlyCollection<ProjectPropertyInstance>(_properties);
            }
        }
        ...
        public ICollection<ProjectItemInstance> Items
        {
            ...
            get
            {
                return (_items == null) ?
                    ...
                    new Shared.ReadOnlyCollection<ProjectItemInstance>(_items);
            }
        }
        ...
        /// </summary>
        public ElementLocation.ElementLocation ProjectFileLocation
        {
        ...
        internal ICollection<ProjectPropertyInstance> TestEnvironmentalProperties => new Shared.ReadOnlyCollection<ProjectPropertyInstance>(_environmentVariableProperties);
        ...
        private void TranslateAllState(ITranslator translator)
        {
            ...
            translator.Translate(ref _projectFileLocation, ElementLocation.ElementLocation.FactoryForDeserialization);
            ...
            bool parentProjectSupportsReturnsAttribute)
        {
            ...
            ProjectTargetInstance target = new ProjectTargetInstance(
                ...
                String.IsNullOrEmpty(condition) ? null : ElementLocation.ElementLocation.EmptyLocation,
                String.IsNullOrEmpty(inputs) ? null : ElementLocation.ElementLocation.EmptyLocation,
                String.IsNullOrEmpty(outputs) ? null : ElementLocation.ElementLocation.EmptyLocation,
                String.IsNullOrEmpty(returns) ? null : ElementLocation.ElementLocation.EmptyLocation,
                String.IsNullOrEmpty(keepDuplicateOutputs) ? null : ElementLocation.ElementLocation.EmptyLocation,
                String.IsNullOrEmpty(dependsOnTargets) ? null : ElementLocation.ElementLocation.EmptyLocation,
                String.IsNullOrEmpty(beforeTargets) ? null : ElementLocation.ElementLocation.EmptyLocation,
                String.IsNullOrEmpty(afterTargets) ? null : ElementLocation.ElementLocation.EmptyLocation,
            ...
            IDirectoryCacheFactory directoryCacheFactory = null)
        {
            ...
            _projectFileLocation = xml.ProjectFileLocation ?? ElementLocation.ElementLocation.EmptyLocation;
            ...
            ElementLocation.ElementLocation toolsVersionLocation = xml.Location;
