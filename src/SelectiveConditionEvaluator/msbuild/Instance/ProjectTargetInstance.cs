...
namespace SelectiveConditionEvaluator.msbuild.Instance
{
    ...
    internal sealed class ProjectTargetInstance : IImmutable, IKeyed, ITranslatable
    {
        /// <summary>
        /// Name of the target
        /// </summary>
        ...
        /// </summary>
        private ElementLocation.ElementLocation _inputsLocation;

        /// <summary>
        /// Location of the outputs attribute, if any
        /// </summary>
        private ElementLocation.ElementLocation _outputsLocation;

        /// <summary>
        /// Location of the returns attribute, if any
        /// </summary>
        private ElementLocation.ElementLocation _returnsLocation;

        /// <summary>
        /// Location of KeepDuplicateOutputs attribute, if any
        /// </summary>
        private ElementLocation.ElementLocation _keepDuplicateOutputsLocation;

        /// <summary>
        /// Location of the DependsOnTargets attribute ,if any
        /// </summary>
        private ElementLocation.ElementLocation _dependsOnTargetsLocation;

        /// <summary>
        /// Location of the BeforeTargets attribute ,if any
        /// </summary>
        private ElementLocation.ElementLocation _beforeTargetsLocation;

        /// <summary>
        /// Location of the AfterTargets attribute ,if any
        /// </summary>
        private ElementLocation.ElementLocation _afterTargetsLocation;
        ...
        internal ProjectTargetInstance(
            ...
            ElementLocation.ElementLocation inputsLocation,
            ElementLocation.ElementLocation outputsLocation,
            ElementLocation.ElementLocation returnsLocation,
            ElementLocation.ElementLocation keepDuplicateOutputsLocation,
            ElementLocation.ElementLocation dependsOnTargetsLocation,
            ElementLocation.ElementLocation beforeTargetsLocation,
            ElementLocation.ElementLocation afterTargetsLocation,
        ...
        public ICollection<ProjectTaskInstance> Tasks
        {
            get
            {
                return new Shared.ReadOnlyCollection<ProjectTaskInstance>(Children.OfType<ProjectTaskInstance>());
            }
        }
        ...
        /// </summary>
        public ElementLocation.ElementLocation InputsLocation
        {
            [DebuggerStepThrough]
            get
        ...
        /// </summary>
        public ElementLocation.ElementLocation OutputsLocation
        {
            [DebuggerStepThrough]
            get
        ...
        /// </summary>
        public ElementLocation.ElementLocation ReturnsLocation
        {
            [DebuggerStepThrough]
            get
        ...
        /// </summary>
        public ElementLocation.ElementLocation DependsOnTargetsLocation
        {
            [DebuggerStepThrough]
            get
        ...
        /// </summary>
        public ElementLocation.ElementLocation BeforeTargetsLocation
        {
            [DebuggerStepThrough]
            get
        ...
        /// </summary>
        public ElementLocation.ElementLocation AfterTargetsLocation
        {
            [DebuggerStepThrough]
            get
        ...
        void ITranslatable.Translate(ITranslator translator)
        {
            ...
            translator.Translate(ref _inputsLocation, ElementLocation.ElementLocation.FactoryForDeserialization);
            translator.Translate(ref _outputsLocation, ElementLocation.ElementLocation.FactoryForDeserialization);
            translator.Translate(ref _returnsLocation, ElementLocation.ElementLocation.FactoryForDeserialization);
            translator.Translate(ref _keepDuplicateOutputsLocation, ElementLocation.ElementLocation.FactoryForDeserialization);
            translator.Translate(ref _dependsOnTargetsLocation, ElementLocation.ElementLocation.FactoryForDeserialization);
            translator.Translate(ref _beforeTargetsLocation, ElementLocation.ElementLocation.FactoryForDeserialization);
            translator.Translate(ref _afterTargetsLocation, ElementLocation.ElementLocation.FactoryForDeserialization);
