...
namespace SelectiveConditionEvaluator.msbuild.Instance.TaskFactories
{
    /// <summary>
    ...
    internal class AssemblyTaskFactory : ITaskFactory2
    {
        ...
        /// </summary>
        internal ITask CreateTaskInstance(ElementLocation.ElementLocation taskLocation, TaskLoggingContext taskLoggingContext, IBuildComponentHost buildComponentHost, IDictionary<string, string> taskIdentityParameters,
#if FEATURE_APPDOMAIN
            ...
            bool isOutOfProc)
        {
            ...
            if ((_factoryIdentityParameters?.Count > 0) || (taskIdentityParameters?.Count > 0))
            {
                ...
                useTaskFactory = !NativeMethods.IsMono
...
#pragma warning restore SA1111, SA1009 // Closing parenthesis should be on line of last parameter
        ...
        /// </summary>
        internal bool TaskNameCreatableByFactory(string taskName, IDictionary<string, string> taskIdentityParameters, string taskProjectFile, TargetLoggingContext targetLoggingContext, ElementLocation.ElementLocation elementLocation)
        {
