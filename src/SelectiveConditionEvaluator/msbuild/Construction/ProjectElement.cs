...
using SelectiveConditionEvaluator.msbuild.ObjectModelRemoting.ConstructionObjectLinks;
using SelectiveConditionEvaluator.msbuild.Shared;
using SelectiveConditionEvaluator.msbuild.Xml;

namespace SelectiveConditionEvaluator.msbuild.Construction
{
    /// <summary>
    /// Abstract base class for MSBuild construction object model elements.
    /// </summary>
    internal abstract class ProjectElement : IProjectElement, ILinkableObject
    {
        /// <summary>
        ...
        /// </summary>
        public ElementLocation.ElementLocation Location => Link != null ? Link.Location : XmlElement.Location;
        ...
        internal ElementLocation.ElementLocation GetAttributeLocation(string attributeName)
        {
