...
using Project = SelectiveConditionEvaluator.msbuild.Definition.Project;
using ProjectCollection = SelectiveConditionEvaluator.msbuild.Definition.ProjectCollection;
using ProjectItem = SelectiveConditionEvaluator.msbuild.Definition.ProjectItem;
