...
using BuildEventFileInfo = SelectiveConditionEvaluator.msbuild.Shared.BuildEventFileInfo;
using ErrorUtilities = SelectiveConditionEvaluator.msbuild.Shared.ErrorUtilities;
using ExceptionUtilities = SelectiveConditionEvaluator.msbuild.Shared.ExceptionHandling;
using ProjectFileErrorUtilities = SelectiveConditionEvaluator.msbuild.Shared.ProjectFileErrorUtilities;
using ResourceUtilities = SelectiveConditionEvaluator.msbuild.Shared.ResourceUtilities;
using VisualStudioConstants = SelectiveConditionEvaluator.msbuild.Shared.VisualStudioConstants;

#nullable disable

namespace SelectiveConditionEvaluator.msbuild.Construction.Solution
{
    /// <remarks>
