...
using SelectiveConditionEvaluator.msbuild.Evaluation.Profiler;
...
using static SelectiveConditionEvaluator.msbuild.Instance.ProjectPropertyInstance;
using EngineFileUtilities = SelectiveConditionEvaluator.msbuild.Utilities.EngineFileUtilities;
...
using SdkReferencePropertyExpansionMode = SelectiveConditionEvaluator.msbuild.EscapeHatches.SdkReferencePropertyExpansionMode;
...
namespace SelectiveConditionEvaluator.msbuild.Evaluation
{
        ...
        where D : class, IItemDefinition<M>
    {
                                            ...
                                            bool throwOnFileNotExistsError, out List<ProjectRootElement> imports)
        {
            ...
            ElementLocation.ElementLocation importLocationInProject = importElement.Location;
