...
using Expander = SelectiveConditionEvaluator.msbuild.Evaluation.Expander<SelectiveConditionEvaluator.msbuild.Definition.ProjectProperty, SelectiveConditionEvaluator.msbuild.Definition.ProjectItem>;
...
namespace SelectiveConditionEvaluator.msbuild.Evaluation
{
    ...
    internal class ProjectParser
    {
        ...
        private void Parse()
        {
            ...
            if (element is null)
            {
                ProjectErrorUtilities.ThrowInvalidProject(ElementLocation.ElementLocation.Create(_document.FullPath), "NoRootProjectElement", XMakeElements.project);
            }
