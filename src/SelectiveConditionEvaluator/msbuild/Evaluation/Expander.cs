...
using TaskItemFactory = SelectiveConditionEvaluator.msbuild.Instance.ProjectItemInstance.TaskItem.TaskItemFactory;
            ...
            where T : class, IProperty
        {
                ...
                LoggingContext loggingContext = null)
            {
                ...
                while (propertyStartIndex != -1)
                {
                    ...
                    {
                        results.Add((object)expression.AsMemory(sourceIndex, propertyStartIndex - sourceIndex));
                    }
                    ...
                    if (propertyEndIndex == -1)
                    {
                        ...
                        results.Add((object)expression.AsMemory(propertyStartIndex, expression.Length - propertyStartIndex));
                ...
                {
                    results.Add((object)expression.AsMemory(sourceIndex, expression.Length - sourceIndex));
                }
            ...
            private static string ExpandRegistryValue(string registryExpression, IElementLocation elementLocation)
            {
                ...
                if (registryKeyName != null)
                {
                    ...
                    try
                    {
                        ...
                        if (!NativeMethods.IsWindows && !registryKeyName.StartsWith("HKEY_CURRENT_USER", StringComparison.OrdinalIgnoreCase))
                        {
                            ...
                            {
                                return NativeMethods.FrameworkBasePath + Path.DirectorySeparatorChar;
                            }
