...
{
    using ILoggingService = ILoggingService;
    ...
    internal sealed class Parser
    {
        ...
        //
        internal GenericExpressionNode Parse(string expression, ParserOptions optionSettings, ElementLocation.ElementLocation elementLocation)
        {
