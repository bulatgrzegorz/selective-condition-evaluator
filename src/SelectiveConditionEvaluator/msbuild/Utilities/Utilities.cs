...
using Toolset = SelectiveConditionEvaluator.msbuild.Definition.Toolset;
using XmlElementWithLocation = SelectiveConditionEvaluator.msbuild.ElementLocation.XmlElementWithLocation;

#nullable disable

namespace SelectiveConditionEvaluator.msbuild.Utilities
{
    /// <summary>
