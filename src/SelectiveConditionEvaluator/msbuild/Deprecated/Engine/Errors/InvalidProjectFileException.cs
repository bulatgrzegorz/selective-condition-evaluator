...
using System.Xml;
using SelectiveConditionEvaluator.msbuild.Deprecated.Engine.Engine;
using SelectiveConditionEvaluator.msbuild.Shared;
using XmlUtilities = SelectiveConditionEvaluator.msbuild.Deprecated.Engine.Shared.XmlUtilities;

namespace SelectiveConditionEvaluator.msbuild.Deprecated.Engine.Errors
{
    /// <summary>
    ...
    [Serializable]
    internal sealed class InvalidProjectFileException : Exception
    {
