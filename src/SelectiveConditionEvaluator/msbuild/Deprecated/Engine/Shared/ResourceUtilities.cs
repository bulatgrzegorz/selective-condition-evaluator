...
namespace SelectiveConditionEvaluator.msbuild.Deprecated.Engine.Shared
{
    /// <summary>
        ...
        internal static void VerifyResourceStringExists(string resourceName)
        {
            ...
            try
            {
                ...
                if (unformattedMessage == null)
                {
                    ...
                    throw new msbuild.Shared.InternalErrorException();
                }
            }
            catch (ArgumentException e)
            {
                Debug.Fail("The resource string \"" + resourceName + "\" was not found.");
                throw new msbuild.Shared.InternalErrorException(e.Message);
            }
