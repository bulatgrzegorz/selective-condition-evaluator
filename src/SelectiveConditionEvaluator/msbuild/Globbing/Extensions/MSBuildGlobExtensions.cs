...
using SelectiveConditionEvaluator.msbuild.Globbing.Visitor;

namespace SelectiveConditionEvaluator.msbuild.Globbing.Extensions
{
    /// <summary>
    /// Extensions for <see cref="IMSBuildGlob"/>
    /// </summary>
    internal static class MSBuildGlobExtensions
    {
        /// <summary>
