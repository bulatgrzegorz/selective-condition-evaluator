...
namespace SelectiveConditionEvaluator.msbuild.Shared
{
    ...
    internal static class FrameworkLocationHelper
    {
        ...
        internal static string dotNetFrameworkVersionFolderPrefixV11 = msbuild.NativeMethods.IsWindows ? "v1.1" : "1.1"; // v1.1 is for Everett.
        ...
        internal static string dotNetFrameworkVersionFolderPrefixV20 = msbuild.NativeMethods.IsWindows ? "v2.0" : "2.0"; // v2.0 is for Whidbey.
        ...
        internal static string dotNetFrameworkVersionFolderPrefixV30 = msbuild.NativeMethods.IsWindows ? "v3.0" : "3.0"; // v3.0 is for WinFx.
        ...
        internal static string dotNetFrameworkVersionFolderPrefixV35 = msbuild.NativeMethods.IsWindows ? "v3.5" : "3.5"; // v3.5 is for Orcas.
        ...
        internal static string dotNetFrameworkVersionFolderPrefixV40 = msbuild.NativeMethods.IsWindows ? "v4.0" : "4.0";
        internal static string dotNetFrameworkVersionFolderPrefixV45 = msbuild.NativeMethods.IsWindows ? "v4.5" : "4.5";
        ...
        internal static string PathToDotNetFrameworkV11
        {
            get
            {
                return msbuild.NativeMethods.IsUnixLike
                           ? Path.Combine(msbuild.NativeMethods.FrameworkBasePath, dotNetFrameworkVersionFolderPrefixV11)
        ...
        internal static string PathToDotNetFrameworkV20
        {
            ...
            {
                return msbuild.NativeMethods.IsUnixLike
                           ? Path.Combine(msbuild.NativeMethods.FrameworkBasePath, dotNetFrameworkVersionFolderPrefixV20)
        ...
        internal static string PathToDotNetFrameworkV30
        {
            ...
            {
                return msbuild.NativeMethods.IsUnixLike
                           ? Path.Combine(msbuild.NativeMethods.FrameworkBasePath, dotNetFrameworkVersionFolderPrefixV30)
        ...
        internal static string PathToDotNetFrameworkV35
        {
            ...
            {
                return msbuild.NativeMethods.IsUnixLike
                           ? Path.Combine(msbuild.NativeMethods.FrameworkBasePath, dotNetFrameworkVersionFolderPrefixV35)
        ...
        internal static string PathToDotNetFrameworkV40
        {
            ...
            {
                return msbuild.NativeMethods.IsUnixLike
                           ? Path.Combine(msbuild.NativeMethods.FrameworkBasePath, dotNetFrameworkVersionFolderPrefixV40)
        ...
        internal static string PathToDotNetFrameworkV45
        {
            ...
            {
                return msbuild.NativeMethods.IsUnixLike
                           ? Path.Combine(msbuild.NativeMethods.FrameworkBasePath, dotNetFrameworkVersionFolderPrefixV45)
        ...
        private static string FallbackDotNetFrameworkSdkInstallPath
        {
            get
            {
                if (s_fallbackDotNetFrameworkSdkInstallPath == null)
                {
                    ...
                    {
                        s_fallbackDotNetFrameworkSdkInstallPath = msbuild.NativeMethods.FrameworkCurrentPath;
                    }
#if FEATURE_WIN32_REGISTRY
                    else
                    {
            ...
            DotNetFrameworkArchitecture architecture)
        {
            if (!msbuild.NativeMethods.IsWindows)
            {
                ...
                var frameworkPath = Path.Combine(msbuild.NativeMethods.FrameworkBasePath, prefix ?? string.Empty);
        ...
        internal static string GenerateProgramFiles32()
        {
            ...
            if (!msbuild.NativeMethods.IsWindows && msbuild.NativeMethods.IsMono)
            {
                return Path.Combine(msbuild.NativeMethods.FrameworkBasePath, "xbuild");
            }
        ...
        internal static string GenerateProgramFilesReferenceAssemblyRoot()
        {
            ...
            combinedPath = msbuild.NativeMethods.IsWindows
                               ? Path.Combine(programFiles32, "Reference Assemblies\\Microsoft\\Framework")
                               : Path.Combine(msbuild.NativeMethods.FrameworkBasePath, "xbuild-frameworks");
        ...
        private static DotNetFrameworkSpec CreateDotNetFrameworkSpecForV4(Version version, Version visualStudioVersion)
        {
            return new DotNetFrameworkSpec(
                ...
                dotNetFrameworkVersionFolderPrefix: msbuild.NativeMethods.IsWindows ? "v4.0" : "v4.5",
        ...
        private class DotNetFrameworkSpec
        {
            ...
            public virtual string GetPathToDotNetFramework(DotNetFrameworkArchitecture architecture)
            {
                ...
                if (this._hasMsBuild &&
                    ...
                    (!FileSystems.Default.FileExists(Path.Combine(generatedPathToDotNetFramework, msbuild.NativeMethods.IsWindows ? "MSBuild.exe" : "mcs.exe")) &&
            ...
            public virtual string GetPathToDotNetFrameworkSdkTools(VisualStudioSpec visualStudioSpec)
            {
                ...
                if (msbuild.NativeMethods.IsUnixLike)
                {
                    string frameworkPath = msbuild.NativeMethods.FrameworkBasePath;
