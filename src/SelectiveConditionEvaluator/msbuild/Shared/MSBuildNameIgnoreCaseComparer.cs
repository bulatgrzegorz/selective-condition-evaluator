...
namespace SelectiveConditionEvaluator.msbuild.Shared
{
    ...
    internal class MSBuildNameIgnoreCaseComparer : IConstrainedEqualityComparer<string>, IEqualityComparer<string>
    {
        ...
        /// </summary>
        private static readonly msbuild.NativeMethods.ProcessorArchitectures s_runningProcessorArchitecture = msbuild.NativeMethods.ProcessorArchitecture;
        ...
        public bool Equals(string compareToString, string constrainedString, int start, int lengthToCompare)
        {
            ...
            if ((s_runningProcessorArchitecture != msbuild.NativeMethods.ProcessorArchitectures.IA64)
                && (s_runningProcessorArchitecture != msbuild.NativeMethods.ProcessorArchitectures.ARM))
            {
