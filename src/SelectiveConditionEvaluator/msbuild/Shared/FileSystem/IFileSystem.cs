...
namespace SelectiveConditionEvaluator.msbuild.Shared.FileSystem
{
     ...
     * Ideally there should be only one, internal interface. However, such an interface would need to be put into the
    ...
    internal interface IFileSystem
    {
        ...
        Stream GetFileStream(string path, FileMode mode, System.IO.FileAccess access, FileShare share);
