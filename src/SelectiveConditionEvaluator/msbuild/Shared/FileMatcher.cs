...
namespace SelectiveConditionEvaluator.msbuild.Shared
{
    ...
    internal class FileMatcher
    {
            ...
            bool stripProjectDirectory)
        {
            ...
            string filespec;
            if (msbuild.NativeMethods.IsLinux && recursionState.SearchData.DirectoryPattern != null)
            {
                filespec = "*.*";
...
#endif
            using (var matchFileExpression = new ReuseableStringBuilder(FileSpecRegexMinLength + msbuild.NativeMethods.MAX_PATH))
            {
        ...
        private static void AppendRegularExpressionFromFixedDirectory(ReuseableStringBuilder regex, string fixedDir)
        {
            ...
            bool isUncPath = msbuild.NativeMethods.IsWindows && fixedDir.Length > 1
            ...
            List<string> excludeSpecsUnescaped)
        {
            ...
            try
            {
                ...
                var maxTasks = Math.Max(1, msbuild.NativeMethods.GetLogicalCoreCount() / 2);
