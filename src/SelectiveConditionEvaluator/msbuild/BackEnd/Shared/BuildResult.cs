...
namespace SelectiveConditionEvaluator.msbuild.BackEnd.Shared
{
    ...
    /// </summary>
    internal class BuildResult : INodePacket, IBuildResults
    {
        /// <summary>
        ...
        /// <summary>
        /// <see cref="ProjectInstance"/> state after the build. This is only provided if <see cref="BuildRequestDataFlags"/>
