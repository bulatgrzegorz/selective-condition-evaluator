...
namespace SelectiveConditionEvaluator.msbuild.BackEnd.Components
{
    /// <summary>
    ...
    internal class BuildComponentFactoryCollection
    {
        ...
        {
            _componentEntriesByType[BuildComponentType.Scheduler] = new BuildComponentEntry(BuildComponentType.Scheduler, Scheduler.Scheduler.CreateComponent, CreationPattern.Singleton);
            ...
            // RemoteNodeProvider,
            // NodePacketFactory,
            _componentEntriesByType[BuildComponentType.RequestEngine] = new BuildComponentEntry(BuildComponentType.RequestEngine, BuildRequestEngine.BuildRequestEngine.CreateComponent, CreationPattern.Singleton);

            // FileMonitor,
            // NodeEndpoint,
            _componentEntriesByType[BuildComponentType.LoggingService] = new BuildComponentEntry(BuildComponentType.LoggingService, null);
            _componentEntriesByType[BuildComponentType.RequestBuilder] = new BuildComponentEntry(BuildComponentType.RequestBuilder, RequestBuilder.RequestBuilder.CreateComponent, CreationPattern.CreateAlways);
