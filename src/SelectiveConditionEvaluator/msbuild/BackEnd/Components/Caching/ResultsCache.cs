...
namespace SelectiveConditionEvaluator.msbuild.BackEnd.Components.Caching
{
    /// <summary>
    ...
    internal class ResultsCache : IResultsCache
    {
        ...
        public void Translate(ITranslator translator)
        {
            ...
            translator.TranslateDictionary(
                ...
                capacity => new ConcurrentDictionary<int, BuildResult>(NativeMethods.GetLogicalCoreCount(), capacity));
