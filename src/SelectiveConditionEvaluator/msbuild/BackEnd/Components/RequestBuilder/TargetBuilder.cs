...
using BuildAbortedException = SelectiveConditionEvaluator.msbuild.BackEnd.Shared.BuildAbortedException;
using ElementLocation = SelectiveConditionEvaluator.msbuild.ElementLocation.ElementLocation;
using ProjectLoggingContext = SelectiveConditionEvaluator.msbuild.BackEnd.Components.Logging.ProjectLoggingContext;
