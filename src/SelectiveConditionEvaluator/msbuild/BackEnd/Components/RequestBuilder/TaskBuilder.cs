...
using ReservedPropertyNames = SelectiveConditionEvaluator.msbuild.Resources.ReservedPropertyNames;
using TargetLoggingContext = SelectiveConditionEvaluator.msbuild.BackEnd.Components.Logging.TargetLoggingContext;
using TaskLoggingContext = SelectiveConditionEvaluator.msbuild.BackEnd.Components.Logging.TaskLoggingContext;

#nullable disable

namespace SelectiveConditionEvaluator.msbuild.BackEnd.Components.RequestBuilder
{
    /// <summary>
    ...
    internal class TaskBuilder : ITaskBuilder, IBuildComponent
    {
        ...
        {
            _componentHost = host;
            _taskExecutionHost = new TaskExecutionHost.TaskExecutionHost(host);
        }
        ...
        private async Task<WorkUnitResult> InitializeAndExecuteTask(TaskLoggingContext taskLoggingContext, ItemBucket bucket, IDictionary<string, string> taskIdentityParameters, TaskHost taskHost, TaskExecutionMode howToExecuteTask)
        {
            ...
            using var assemblyLoadsTracker = AssemblyLoadsTracker.StartTracking(taskLoggingContext, AssemblyLoadingContext.TaskRun, (_taskExecutionHost as TaskExecutionHost.TaskExecutionHost)?.TaskInstance?.GetType());
        ...
        private async Task<WorkUnitResult> ExecuteInstantiatedTask(ITaskExecutionHost taskExecutionHost, TaskLoggingContext taskLoggingContext, TaskHost taskHost, ItemBucket bucket, TaskExecutionMode howToExecuteTask)
        {
            ...
            else
            {
                ...
                TaskExecutionHost.TaskExecutionHost host = taskExecutionHost as TaskExecutionHost.TaskExecutionHost;
