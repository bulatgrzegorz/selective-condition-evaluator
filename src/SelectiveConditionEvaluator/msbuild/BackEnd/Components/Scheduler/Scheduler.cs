...
using NodeLoggingContext = SelectiveConditionEvaluator.msbuild.BackEnd.Components.Logging.NodeLoggingContext;

#nullable disable

namespace SelectiveConditionEvaluator.msbuild.BackEnd.Components.Scheduler
{
    /// <summary>
    ...
    internal class Scheduler : IScheduler
    {
        ...
        public Scheduler()
        {
            ...
            {
                _coreLimit = NativeMethods.GetLogicalCoreCount();
            }
