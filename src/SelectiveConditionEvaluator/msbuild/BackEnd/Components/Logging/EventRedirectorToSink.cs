...
namespace SelectiveConditionEvaluator.msbuild.BackEnd.Components.Logging
{
    ...
    internal class EventRedirectorToSink : IEventRedirector
    {
        ...
        /// <exception cref="msbuild.Shared.InternalErrorException">Eventsink is null</exception>
        /// <exception cref="msbuild.Shared.InternalErrorException">LoggerId is less than 0</exception>
