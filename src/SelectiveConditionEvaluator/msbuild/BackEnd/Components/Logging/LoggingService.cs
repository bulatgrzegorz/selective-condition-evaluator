...
using SelectiveConditionEvaluator.msbuild.BackEnd.Components.Caching;
using SelectiveConditionEvaluator.msbuild.BackEnd.Components.Communications;
using SelectiveConditionEvaluator.msbuild.BackEnd.Components.Logging.DistributedLoggers;
...
using SelectiveConditionEvaluator.msbuild.Logging;
using SelectiveConditionEvaluator.msbuild.Shared;
using InternalLoggerException = SelectiveConditionEvaluator.msbuild.Errors.InternalLoggerException;
using LoggerDescription = SelectiveConditionEvaluator.msbuild.Logging.LoggerDescription;
...
namespace SelectiveConditionEvaluator.msbuild.BackEnd.Components.Logging
{
    ...
    internal partial class LoggingService : ILoggingService, INodePacketHandler, IBuildComponent
    {
        ...
        /// <exception cref="msbuild.Shared.InternalErrorException">When buildComponentHost is null</exception>
        /// <exception cref="msbuild.Shared.InternalErrorException">Service has already shutdown</exception>
        ...
        /// <exception cref="msbuild.Shared.InternalErrorException">Packet is null</exception>
        /// <exception cref="msbuild.Shared.InternalErrorException">Packet is not a NodePacketType.LogMessage</exception>
        ...
        /// <exception cref="msbuild.Shared.InternalErrorException">If logger is null</exception>
        ...
        /// <exception cref="msbuild.Shared.InternalErrorException">If forwardingLogger is null</exception>
        ...
        /// <exception cref="msbuild.Shared.InternalErrorException">When forwardingLoggerSink is null</exception>
        /// <exception cref="msbuild.Shared.InternalErrorException">When loggerDescriptions is null</exception>
        ...
        /// <exception cref="msbuild.Shared.InternalErrorException">buildEvent is null</exception>
        ...
        /// </summary>
        /// <exception cref="msbuild.Shared.InternalErrorException">WaitHandle returns something other than 0 or 1</exception>
        ...
        private void UpdateMinimumMessageImportance(ILogger logger)
        {
            ...
            MessageImportance? minimumImportance = innerLogger switch
            {
                ...
                BuildManager.BuildManager.NullLogger => null,
