...
namespace SelectiveConditionEvaluator.msbuild.BackEnd.Components.Logging
{
    ...
    internal partial class LoggingService : ILoggingService, INodePacketHandler, IBuildComponent
    {
        ...
        /// <exception cref="msbuild.Shared.InternalErrorException">MessageResourceName is null</exception>
        ...
        /// <exception cref="msbuild.Shared.InternalErrorException">BuildEventContext is null</exception>
        /// <exception cref="msbuild.Shared.InternalErrorException">Message is null</exception>
        ...
        /// <exception cref="msbuild.Shared.InternalErrorException">File is null</exception>
        /// <exception cref="msbuild.Shared.InternalErrorException">Message is null</exception>
        ...
        /// <exception cref="msbuild.Shared.InternalErrorException">InvalidProjectFileException is null</exception>
        /// <exception cref="msbuild.Shared.InternalErrorException">BuildEventContext is null</exception>
        ...
        /// <exception cref="msbuild.Shared.InternalErrorException">TaskName is null</exception>
            ...
            string projectFile)
        {
            ...
            int nodeId = Scheduler.Scheduler.InProcNodeId;
        ...
        /// <exception cref="msbuild.Shared.InternalErrorException">parentBuildEventContext is null</exception>
        /// <exception cref="msbuild.Shared.InternalErrorException">projectBuildEventContext is null</exception>
            ...
            int projectContextId = BuildEventContext.InvalidProjectContextId)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (nodeBuildEventContext.NodeId == Scheduler.Scheduler.InProcNodeId)
                    {
