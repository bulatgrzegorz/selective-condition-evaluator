...
namespace SelectiveConditionEvaluator.msbuild.BackEnd.Client
{
    ...
    /// </summary>
    internal sealed class MSBuildClient
    {
        /// <summary>
...
#pragma warning restore SA1111, SA1009 // Closing parenthesis should be on line of last parameter
        ...
        {
            (var acceptAnsiColorCodes, var outputIsScreen, _originalConsoleMode) = NativeMethods.QueryIsScreenAndTryEnableAnsiColorCodes();
        ...
        private void HandlePacketPumpCompleted(MSBuildClientPacketPump packetPump)
        {
            if (packetPump.PacketPumpException != null)
            {
                ...
                throw packetPump.PacketPumpException ?? new msbuild.Shared.InternalErrorException("Packet pump unexpectedly shut down");
            }
