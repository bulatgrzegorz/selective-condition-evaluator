...
namespace SelectiveConditionEvaluator.msbuild.BackEnd.TaskExecutionHost.AddInParts
{
    /// <summary>
    ...
    internal interface ITaskExecutionHost
    {
        ...
        /// </summary>
        void InitializeForTask(IBuildEngine2 buildEngine, TargetLoggingContext loggingContext, ProjectInstance projectInstance, string taskName, ElementLocation.ElementLocation taskLocation, ITaskHost taskHost, bool continueOnError,
        ...
        /// </summary>
        bool SetTaskParameters(IDictionary<string, (string, ElementLocation.ElementLocation)> parameters);

        /// <summary>
        /// Gets all of the outputs and stores them in the batch bucket.
        /// </summary>
        bool GatherTaskOutputs(string parameterName, ElementLocation.ElementLocation parameterLocation, bool outputTargetIsItem, string outputTargetName);
