...
using System.Text;
using SelectiveConditionEvaluator.msbuild.BackEnd.Components;
...
using SelectiveConditionEvaluator.msbuild.BackEnd.Components.RequestBuilder.IntrinsicTasks;
using SelectiveConditionEvaluator.msbuild.BackEnd.TaskExecutionHost.AddInParts;
...
using SelectiveConditionEvaluator.msbuild.Instance.TaskFactories;
using SelectiveConditionEvaluator.msbuild.Shared;
using TaskItem = SelectiveConditionEvaluator.msbuild.Instance.ProjectItemInstance.TaskItem;
using Task = System.Threading.Tasks.Task;

#nullable disable

namespace SelectiveConditionEvaluator.msbuild.BackEnd.TaskExecutionHost
{
    /// <summary>
    ...
    internal class TaskExecutionHost : ITaskExecutionHost, IDisposable
    {
        ...
        /// </summary>
        void ITaskExecutionHost.InitializeForTask(IBuildEngine2 buildEngine, TargetLoggingContext loggingContext, ProjectInstance projectInstance, string taskName, ElementLocation.ElementLocation taskLocation, ITaskHost taskHost, bool continueOnError,
#if FEATURE_APPDOMAIN
        ...
        bool ITaskExecutionHost.SetTaskParameters(IDictionary<string, (string, ElementLocation.ElementLocation)> parameters)
        {
            ...
            foreach (KeyValuePair<string, (string, ElementLocation.ElementLocation)> parameter in parameters)
            {
        ...
        bool ITaskExecutionHost.GatherTaskOutputs(string parameterName, ElementLocation.ElementLocation parameterLocation, bool outputTargetIsItem, string outputTargetName)
        {
        ...
        /// Called on the local side.
        /// </summary>
        private bool SetParameterArray(TaskPropertyInfo parameter, Type parameterType, IList<TaskItem> taskItems, ElementLocation.ElementLocation parameterLocation)
        {
        ...
        private bool SetTaskParameter(
            ...
            ElementLocation.ElementLocation parameterLocation,
            bool isRequired,
        ...
        /// </summary>
        private void GatherTaskItemOutputs(bool outputTargetIsItem, string outputTargetName, ITaskItem[] outputs, ElementLocation.ElementLocation parameterLocation, TaskPropertyInfo parameter)
        {
        ...
        /// </summary>
        private void GatherArrayStringAndValueOutputs(bool outputTargetIsItem, string outputTargetName, string[] outputs, ElementLocation.ElementLocation parameterLocation, TaskPropertyInfo parameter)
        {
            // if the task has generated outputs (if it didn't, don't do anything)
            if (outputs != null)
            {
