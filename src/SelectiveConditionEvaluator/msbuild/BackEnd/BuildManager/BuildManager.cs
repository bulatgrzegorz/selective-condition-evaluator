...
using SelectiveConditionEvaluator.msbuild.BackEnd.Client;
using SelectiveConditionEvaluator.msbuild.BackEnd.Components;
using SelectiveConditionEvaluator.msbuild.BackEnd.Components.BuildRequestEngine;
...
using SelectiveConditionEvaluator.msbuild.BackEnd.Components.FileAccesses;
...
using SelectiveConditionEvaluator.msbuild.BackEnd.Node;
...
using SelectiveConditionEvaluator.msbuild.Graph;
using SelectiveConditionEvaluator.msbuild.Instance;
using SelectiveConditionEvaluator.msbuild.Logging;
using SelectiveConditionEvaluator.msbuild.Logging.BinaryLogger;
using SelectiveConditionEvaluator.msbuild.Resources;
using SelectiveConditionEvaluator.msbuild.Shared;
using SelectiveConditionEvaluator.msbuild.Shared.Debugging;
using SelectiveConditionEvaluator.msbuild.StringTools;
using ConfigurableForwardingLogger = SelectiveConditionEvaluator.msbuild.Logging.DistributedLoggers.ConfigurableForwardingLogger;
...
namespace SelectiveConditionEvaluator.msbuild.BackEnd.BuildManager
{
    ...
    internal class BuildManager : INodePacketHandler, IBuildComponentHost, IDisposable
    {
        ...
        private enum BuildManagerState
        {
            ...
            /// <see cref="BuildManager.PendBuildRequest(SelectiveConditionEvaluator.msbuild.BackEnd.BuildManager.BuildRequestData)"/>, <see cref="BuildManager.BuildRequest(SelectiveConditionEvaluator.msbuild.BackEnd.BuildManager.BuildRequestData)"/>, <see cref="BuildManager.PendBuildRequest(GraphBuildRequestData)"/>, <see cref="BuildRequest"/>, and <see cref="BuildManager.EndBuild()"/> may be called in this state.
            /// </summary>
            Building,
        ...
        /// </summary>
        internal readonly struct DeferredBuildMessage
        {
