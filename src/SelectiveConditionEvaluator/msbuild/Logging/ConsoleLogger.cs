...
namespace SelectiveConditionEvaluator.msbuild.Logging
{
    ...
    internal delegate void WriteHandler(string message);

    /// <summary>
    /// Type of delegate used to set console color.
    /// </summary>
    /// <param name="color">Text color</param>
    internal delegate void ColorSetter(ConsoleColor color);

    /// <summary>
    /// Type of delegate used to reset console color.
    /// </summary>
    internal delegate void ColorResetter();
    ...
    internal class ConsoleLogger : INodeLogger
    {
