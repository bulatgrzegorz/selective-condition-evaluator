...
namespace SelectiveConditionEvaluator.msbuild.Logging
{
    ...
    internal abstract class BaseConsoleLogger : INodeLogger, IStringBuilderProvider
    {
        ...
        {
            runningWithCharacterFileType = Framework.NativeMethods.IsWindows && ConsoleConfiguration.OutputIsScreen;
        }
        ...
        internal List<DictionaryEntry> ExtractPropertyList(IEnumerable properties)
        {
            ...
            Utilities.Utilities.EnumerateProperties(properties, list, static (list, kvp) => list.Add(new DictionaryEntry(kvp.Key, kvp.Value)));
        ...
        internal SortedList ExtractItemList(IEnumerable items)
        {
            ...
            Utilities.Utilities.EnumerateItems(items, item =>
            {
