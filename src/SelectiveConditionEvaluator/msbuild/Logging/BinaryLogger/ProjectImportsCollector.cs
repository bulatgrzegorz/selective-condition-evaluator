...
namespace SelectiveConditionEvaluator.msbuild.Logging.BinaryLogger
{
    ...
    internal class ProjectImportsCollector
    {
        ...
        public ProjectImportsCollector(string logFilePath, bool createFile, string sourcesArchiveExtension = ".ProjectImports.zip")
        {
            ...
            try
            {
                _fileStream = new FileStream(ArchiveFilePath, FileMode.Create, System.IO.FileAccess.ReadWrite, FileShare.Delete);
        ...
        private void AddFileCore(string filePath)
        {
            ...
            using FileStream content = new FileStream(filePath, FileMode.Open, System.IO.FileAccess.Read, FileShare.Read | FileShare.Delete);
