...
using SelectiveConditionEvaluator.msbuild.Globbing;
using SelectiveConditionEvaluator.msbuild.Instance;
using SelectiveConditionEvaluator.msbuild.ObjectModelRemoting;
using SelectiveConditionEvaluator.msbuild.ObjectModelRemoting.DefinitionObjectsLinks;
using SelectiveConditionEvaluator.msbuild.Shared;
using Constants = SelectiveConditionEvaluator.msbuild.Resources.Constants;
using EvaluationItemExpressionFragment = SelectiveConditionEvaluator.msbuild.Evaluation.ItemSpec<SelectiveConditionEvaluator.msbuild.Definition.ProjectProperty, SelectiveConditionEvaluator.msbuild.Definition.ProjectItem>.ItemExpressionFragment;
using EvaluationItemSpec = SelectiveConditionEvaluator.msbuild.Evaluation.ItemSpec<SelectiveConditionEvaluator.msbuild.Definition.ProjectProperty, SelectiveConditionEvaluator.msbuild.Definition.ProjectItem>;
using ForwardingLoggerRecord = SelectiveConditionEvaluator.msbuild.BackEnd.Components.Logging.ForwardingLoggerRecord;
using ILoggingService = SelectiveConditionEvaluator.msbuild.BackEnd.Components.Logging.ILoggingService;
using InvalidProjectFileException = SelectiveConditionEvaluator.msbuild.Errors.InvalidProjectFileException;
using ObjectModel = System.Collections.ObjectModel;
using ProjectItemFactory = SelectiveConditionEvaluator.msbuild.Definition.ProjectItem.ProjectItemFactory;
...
namespace SelectiveConditionEvaluator.msbuild.Definition
{
    ...
    internal class Project : ILinkableObject
    {
        /// <summary>
    ...
    /// </summary>
    internal class ProvenanceResult
    {
        /// <summary>
