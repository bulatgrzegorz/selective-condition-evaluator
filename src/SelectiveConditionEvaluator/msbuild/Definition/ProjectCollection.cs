...
using LoggerMode = SelectiveConditionEvaluator.msbuild.BackEnd.Components.Logging.LoggerMode;
...
namespace SelectiveConditionEvaluator.msbuild.Definition
{
    ...
    internal class ProjectCollection : IToolsetProvider, IBuildComponent, IDisposable
    {
        /// <summary>
        ...
        internal delegate void ProjectAddedEventHandler(object sender, ProjectAddedToProjectCollectionEventArgs e);
        ...
        {
            _loggingService = BackEnd.Components.Logging.LoggingService.CreateLoggingService(_loggerMode, 0 /*Evaluation can be done as if it was on node "0"*/);
        ...
        /// </summary>
        [SuppressMessage("Microsoft.Design", "CA1034:NestedTypesShouldNotBeVisible", Justification = "This has been API reviewed")]
        internal class ProjectAddedToProjectCollectionEventArgs : EventArgs
        {
            /// <summary>
