...
using SelectiveConditionEvaluator.msbuild.ElementLocation;
...
namespace SelectiveConditionEvaluator.msbuild.ObjectModelRemoting.ConstructionObjectLinks
{
    ...
    /// external linking.
    /// <see cref="XmlElement"/> and <see cref="ProjectElement.Link"/>
    /// </summary>
    ...
    /// </summary>
    internal abstract class ProjectElementLink : ILinkedXml
    {
        /// <summary>
        ...
        /// </summary>
        public abstract ElementLocation.ElementLocation GetAttributeLocation(string attributeName);
        ...
        public static ElementLocation.ElementLocation GetAttributeLocation(ProjectElement xml, string attributeName) => xml.GetAttributeLocation(attributeName);
    ...
    internal struct XmlAttributeLink
    {
    ...
    /// </summary>
    internal abstract class ProjectOnErrorElementLink : ProjectElementLink { }

    /// <summary>
    /// External projects support.
    /// Allow for creating a local representation to external object of type <see cref="ProjectOutputElement"/>
    /// </summary>
    internal abstract class ProjectOutputElementLink : ProjectElementLink { }
}
