...
using NativeMethods = SelectiveConditionEvaluator.Shared.NativeMethods;
...
namespace Microsoft.Build.BackEnd.Logging
{
    ...
    internal abstract class BaseConsoleLogger : INodeLogger, IStringBuilderProvider
    {
        ...
        {
            this.WriteHandler(Environment.NewLine);
        }
        ...
        internal void WritePretty(int indentLevel, string formattedString)
        {
            ...
            this.WriteHandler(result.ToString());
        }
        ...
        internal void WriteLinePretty(int indentLevel, string formattedString)
        {
            ...
            this.WriteHandler(IndentString(formattedString, indentLevel * tabWidth));
        }
        ...
        {
            runningWithCharacterFileType = SelectiveConditionEvaluator.Framework.NativeMethods.IsWindows && ConsoleConfiguration.OutputIsScreen;
        }
        ...
        internal List<DictionaryEntry> ExtractPropertyList(IEnumerable properties)
        {
            ...
            Utilities.EnumerateProperties(properties, list, static (list, kvp) => list.Add(new DictionaryEntry(kvp.Key, kvp.Value)));
        ...
        internal SortedList ExtractItemList(IEnumerable items)
        {
            ...
            Utilities.EnumerateItems(items, item =>
            {
        ...
        ///
        /// </summary>
        internal Hashtable projectEvaluationPerformanceCounters;
