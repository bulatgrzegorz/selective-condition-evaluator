...
namespace SelectiveConditionEvaluator.Shared
{
    ...
    internal static class FrameworkLocationHelper
    {
        ...
        internal static string dotNetFrameworkVersionFolderPrefixV11 = SelectiveConditionEvaluator.NativeMethods.IsWindows ? "v1.1" : "1.1"; // v1.1 is for Everett.
        ...
        internal static string dotNetFrameworkVersionFolderPrefixV20 = SelectiveConditionEvaluator.NativeMethods.IsWindows ? "v2.0" : "2.0"; // v2.0 is for Whidbey.
        ...
        internal static string dotNetFrameworkVersionFolderPrefixV30 = SelectiveConditionEvaluator.NativeMethods.IsWindows ? "v3.0" : "3.0"; // v3.0 is for WinFx.
        ...
        internal static string dotNetFrameworkVersionFolderPrefixV35 = SelectiveConditionEvaluator.NativeMethods.IsWindows ? "v3.5" : "3.5"; // v3.5 is for Orcas.
        ...
        internal static string dotNetFrameworkVersionFolderPrefixV40 = SelectiveConditionEvaluator.NativeMethods.IsWindows ? "v4.0" : "4.0";
        internal static string dotNetFrameworkVersionFolderPrefixV45 = SelectiveConditionEvaluator.NativeMethods.IsWindows ? "v4.5" : "4.5";
        ...
        internal static string PathToDotNetFrameworkV11
        {
            get
            {
                return SelectiveConditionEvaluator.NativeMethods.IsUnixLike
                           ? Path.Combine(SelectiveConditionEvaluator.NativeMethods.FrameworkBasePath, dotNetFrameworkVersionFolderPrefixV11)
        ...
        internal static string PathToDotNetFrameworkV20
        {
            ...
            {
                return SelectiveConditionEvaluator.NativeMethods.IsUnixLike
                           ? Path.Combine(SelectiveConditionEvaluator.NativeMethods.FrameworkBasePath, dotNetFrameworkVersionFolderPrefixV20)
        ...
        internal static string PathToDotNetFrameworkV30
        {
            ...
            {
                return SelectiveConditionEvaluator.NativeMethods.IsUnixLike
                           ? Path.Combine(SelectiveConditionEvaluator.NativeMethods.FrameworkBasePath, dotNetFrameworkVersionFolderPrefixV30)
        ...
        internal static string PathToDotNetFrameworkV35
        {
            ...
            {
                return SelectiveConditionEvaluator.NativeMethods.IsUnixLike
                           ? Path.Combine(SelectiveConditionEvaluator.NativeMethods.FrameworkBasePath, dotNetFrameworkVersionFolderPrefixV35)
        ...
        internal static string PathToDotNetFrameworkV40
        {
            ...
            {
                return SelectiveConditionEvaluator.NativeMethods.IsUnixLike
                           ? Path.Combine(SelectiveConditionEvaluator.NativeMethods.FrameworkBasePath, dotNetFrameworkVersionFolderPrefixV40)
        ...
        internal static string PathToDotNetFrameworkV45
        {
            ...
            {
                return SelectiveConditionEvaluator.NativeMethods.IsUnixLike
                           ? Path.Combine(SelectiveConditionEvaluator.NativeMethods.FrameworkBasePath, dotNetFrameworkVersionFolderPrefixV45)
        ...
        private static string FallbackDotNetFrameworkSdkInstallPath
        {
            get
            {
                if (s_fallbackDotNetFrameworkSdkInstallPath == null)
                {
                    ...
                    {
                        s_fallbackDotNetFrameworkSdkInstallPath = SelectiveConditionEvaluator.NativeMethods.FrameworkCurrentPath;
                    }
#if FEATURE_WIN32_REGISTRY
                    else
                    {
            ...
            DotNetFrameworkArchitecture architecture)
        {
            if (!SelectiveConditionEvaluator.NativeMethods.IsWindows)
            {
                ...
                var frameworkPath = Path.Combine(SelectiveConditionEvaluator.NativeMethods.FrameworkBasePath, prefix ?? string.Empty);
        ...
        internal static string GenerateProgramFiles32()
        {
            ...
            if (!SelectiveConditionEvaluator.NativeMethods.IsWindows && SelectiveConditionEvaluator.NativeMethods.IsMono)
            {
                return Path.Combine(SelectiveConditionEvaluator.NativeMethods.FrameworkBasePath, "xbuild");
            }
        ...
        internal static string GenerateProgramFilesReferenceAssemblyRoot()
        {
            ...
            combinedPath = SelectiveConditionEvaluator.NativeMethods.IsWindows
                               ? Path.Combine(programFiles32, "Reference Assemblies\\Microsoft\\Framework")
                               : Path.Combine(SelectiveConditionEvaluator.NativeMethods.FrameworkBasePath, "xbuild-frameworks");
        ...
        private static DotNetFrameworkSpec CreateDotNetFrameworkSpecForV4(Version version, Version visualStudioVersion)
        {
            return new DotNetFrameworkSpec(
                ...
                dotNetFrameworkVersionFolderPrefix: SelectiveConditionEvaluator.NativeMethods.IsWindows ? "v4.0" : "v4.5",
        ...
        private class DotNetFrameworkSpec
        {
            ...
            public virtual string GetPathToDotNetFramework(DotNetFrameworkArchitecture architecture)
            {
                ...
                if (this._hasMsBuild &&
                    ...
                    (!FileSystems.Default.FileExists(Path.Combine(generatedPathToDotNetFramework, SelectiveConditionEvaluator.NativeMethods.IsWindows ? "MSBuild.exe" : "mcs.exe")) &&
            ...
            public virtual string GetPathToDotNetFrameworkSdkTools(VisualStudioSpec visualStudioSpec)
            {
                ...
                {
                    string frameworkPath = SelectiveConditionEvaluator.NativeMethods.FrameworkBasePath;
